  ...
  return (
    <div className="min-h-screen bg-primary-black text-gray-200 selection:bg-primary-pink selection:text-white flex flex-col">
      <header className="fixed top-0 inset-x-0 z-[100]">
        {/* Promo / utility bar */}
        <div className="bg-accent-gold text-secondary-pink text-[10px] sm:text-[11px] font-bold uppercase tracking-widest">
          <div className="container mx-auto px-6 h-9 flex items-center justify-between gap-4">
            ...
            <a
              ...
              className="hidden sm:inline text-primary-pink hover:text-secondary-pink hover:underline whitespace-nowrap"
            >
              Order on WhatsApp
            </a>
          </div>
