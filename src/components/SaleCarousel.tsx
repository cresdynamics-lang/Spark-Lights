...
export default function SaleCarousel({ products }: { products: StoreProduct[] }) {
  ...
  return (
    <div className="relative">
      <div className="absolute -top-16 right-0 hidden sm:flex gap-3">
        <button
          onClick={() => scrollBy(-1)}
          className="w-12 h-12 border border-white/15 flex items-center justify-center hover:bg-primary-gold hover:border-primary-gold transition-all text-white"
